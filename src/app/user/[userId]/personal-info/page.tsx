        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             ...
             <div>
                ...
                <Input defaultValue={`@${user?.name?.toLowerCase().replace(' ', '')}`} className="mt-1"/>
            </div>
             <div>
                <label className="text-sm font-medium">Email Address</label>
                <Input defaultValue={`${user?.name?.toLowerCase().replace(' ', '.')}@email.com`} type="email" readOnly disabled className="mt-1"/>
            </div>
             <div>
