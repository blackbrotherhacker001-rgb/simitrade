...
import { BarChart2, User, Shield, Bell, Wallet, Home, Key, ArrowLeft, ChevronRight, LayoutDashboard } from 'lucide-react';
                    ...
                    <div>
                     ...
                     <div className="w-full flex justify-between text-xs text-muted-foreground">
                         <span>Member Since 9/4/2025</span>
                          <Link href="/dashboard/personal-info" className="flex items-center text-primary">
